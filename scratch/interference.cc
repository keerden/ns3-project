...
current version of this could be found at: https://github.com/keerden/ns3-project



Koos Eerden, April 2016

Based on the example wifi-wired-bridging.cc and
inspired by wifitcpm3.cc found on https://github.com/hedi02/WirelessNetworking
...
NS_LOG_COMPONENT_DEFINE("Interfering-wifi");
...
int main(int argc, char* argv[])
{
	...
	//vectors for containing object for each network
    ...
    cmd.AddValue("anim", "Use NetAnim", anim);
    ...
    // setup channel and physical layer
    ...
    for (uint32_t i = 0; i < nWifis; ++i) {
        ...
        wifiMac.SetType("ns3::ApWifiMac",
            "Ssid", SsidValue(ssid),
            "EnableBeaconJitter", BooleanValue(true));    //very important in this case
    ...
    wifiPhy.EnablePcap("wifitcp-sta", staDevices[0]);
    //Ipv4GlobalRoutingHelper::PopulateRoutingTables ();

    if (anim) // if set, outpu network animator data
        AnimationInterface anim("Interfering-wifi.xml");
